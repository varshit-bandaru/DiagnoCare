...
<header class="navbar">
        <ul class="navbaritem">
           ...
           <!--  <li class="navbartabs"><a href=""></a></li>
            <li class="navbartabs"><a href="">Ipad</a></li>
            <li class="navbartabs"><a href=""></a></li> -->
            ...
            <!-- <li class="navbartabs navbarlogo"><a href="" id="searchlogo"><i class="fas fa-search" role="button"></i></a></li>
            <li class="navbartabs navbarlogo"><a href="" id="shoppinglogo"><i class="fas fa-shopping-bag"></i></a></li> -->
